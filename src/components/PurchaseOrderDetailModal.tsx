...
function makeStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    subtitle: { marginTop: 4, fontSize: 13.5, color: c.textMuted },
    body: { marginTop: 14 },
    tableHead: {
      flexDirection: "row",
      paddingBottom: 6,
    ...
    num: { flex: 1, textAlign: "right", fontFamily: "monospace", fontSize: 14 },
    obs: { marginTop: 12, fontSize: 13.5, color: c.textMuted, fontStyle: "italic" },
    reject: { marginTop: 12, fontSize: 13.5, color: c.destructive, fontWeight: "600" },
    error: { marginTop: 12, fontSize: 13.5, color: c.destructive },
